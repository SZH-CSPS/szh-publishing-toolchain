# Attic — filtres/scripts débranchés par D35 (2026-07-15)

Chaîne d'import v2 (D27–D30) : heuristiques (`szh-import.lua`), liaison des
citations citeproc (`szh-citations.lua`) et rapport de conversion trilingue

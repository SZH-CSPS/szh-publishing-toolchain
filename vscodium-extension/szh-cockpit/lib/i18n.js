...
const TEXTES_COCKPIT = {
  fr: {
    ...
    'ressource.ajouter.horizon': 'Ajouter une entrée',
    'ressource.ajouter.horizon.tip': 'Ajouter une nouvelle entrée du tour d’horizon',
    ...
    'doc.traductions.vide': 'Aucune traduction à faire pour l’instant.',
    'doc.traductions.traduire': 'Traduire dans ce numéro',
    'doc.traductions.traduire.tip': 'Créer la fiche dans cette langue à partir du texte reçu, rattachée à ce numéro',
    'doc.reservoir.filtre': 'Numéro',
    'doc.reservoir.filtre.tous': 'Tous les numéros',
    'doc.reservoir.archive': '(archivé)',
    'doc.reservoir.vide': 'Rien dans le réservoir pour l’instant.',
    'doc.reservoir.atraduire': 'À traduire',
    'doc.reservoir.atraduire.tip': 'Marquer cette fiche à traduire : elle passe dans « Traductions à faire »',
    'doc.reservoir.ignorer': 'Ignorer',
    'doc.reservoir.ignorer.tip': 'Ignorer cette fiche : elle ne sera plus proposée ici',
    'doc.reservoir.afficherIgnorees': 'Afficher les ignorées',
    'doc.reservoir.toutSelectionner': 'Tout sélectionner',
    'doc.reservoir.annuler': 'Annuler la décision',
    'doc.reservoir.annuler.tip': 'Revenir sur cette décision : la fiche reprend sa place dans le réservoir',
    'doc.orphelines.titre': 'Mes orphelines',
    'doc.orphelines.vide': 'Aucune fiche orpheline pour l’instant.',
    'doc.orphelines.tirer': 'Tirer dans ce numéro',
    'doc.orphelines.tirer.tip': 'Rattacher cette fiche orpheline à ce numéro',
    'doc.origine.numero': '{0}, numéro {1}',
    'doc.id.double': 'L’identifiant de ce numéro est aussi porté par : {0}. Vérifiez qu’il ne s’agit pas d’un dossier copié par erreur.',

    // ── Onglet Archive : toute la bibliothèque de production, lecture seule ────
    'doc.onglet.archive': 'Archive',
    ...
    'doc.archive.filtre.typeTous': 'Tous les types',
    'doc.archive.filtre.revue': 'Revue',
    'doc.archive.filtre.revueToutes': 'Les deux revues',
    'doc.archive.filtre.numero': 'Numéro',
    'doc.archive.filtre.numeroTous': 'Tous les numéros',
    'doc.archive.filtre.annee': 'Année',
    'doc.archive.filtre.anneeToutes': 'Toutes les années',
    'doc.archive.aucunResultat': 'Aucune fiche ne correspond à ce filtre.',
  ...
  de: {
    ...
    'ressource.ajouter.horizon': 'Eintrag hinzufügen',
    'ressource.ajouter.horizon.tip': 'Einen neuen Eintrag der Rundschau hinzufügen',
    ...
    'doc.traductions.vide': 'Im Moment nichts zu übersetzen.',
    'doc.traductions.traduire': 'In diese Ausgabe übernehmen',
    'doc.traductions.traduire.tip': 'Den Eintrag in dieser Sprache aus dem erhaltenen Text erstellen, dieser Ausgabe zugeordnet',
    'doc.reservoir.filtre': 'Ausgabe',
    'doc.reservoir.filtre.tous': 'Alle Ausgaben',
    'doc.reservoir.archive': '(archiviert)',
    'doc.reservoir.vide': 'Die Reserve ist im Moment leer.',
    'doc.reservoir.atraduire': 'Zu übersetzen',
    'doc.reservoir.atraduire.tip': 'Diesen Eintrag zur Übersetzung markieren: er erscheint unter «Zu übersetzen»',
    'doc.reservoir.ignorer': 'Ignorieren',
    'doc.reservoir.ignorer.tip': 'Diesen Eintrag ignorieren: er wird hier nicht mehr vorgeschlagen',
    'doc.reservoir.afficherIgnorees': 'Ignorierte anzeigen',
    'doc.reservoir.toutSelectionner': 'Alle auswählen',
    'doc.reservoir.annuler': 'Entscheidung rückgängig machen',
    'doc.reservoir.annuler.tip': 'Diese Entscheidung rückgängig machen: der Eintrag erscheint wieder in der Reserve',
    'doc.orphelines.titre': 'Meine herrenlosen Einträge',
    'doc.orphelines.vide': 'Im Moment keine herrenlosen Einträge.',
    'doc.orphelines.tirer': 'In diese Ausgabe übernehmen',
    'doc.orphelines.tirer.tip': 'Diesen herrenlosen Eintrag dieser Ausgabe zuordnen',
    ...
    'doc.archive.actualiser.tip': 'Die Produktionsbibliothek neu einlesen',
    'doc.archive.ancrageIntrouvable': 'Freigegebener SharePoint-Ordner nicht gefunden: das Archiv kann derzeit nicht gelesen werden.',
    'doc.archive.vide': 'Die Produktionsbibliothek enthält noch keinen Eintrag.',
    'doc.archive.rechercheIndice': 'Suchen (Titel, Beschreibung, Autor:innen…)',
    'doc.archive.filtre.type': 'Typ',
    'doc.archive.filtre.typeTous': 'Alle Typen',
    'doc.archive.filtre.revue': 'Zeitschrift',
    'doc.archive.filtre.revueToutes': 'Beide Zeitschriften',
    'doc.archive.filtre.numero': 'Ausgabe',
    'doc.archive.filtre.numeroTous': 'Alle Ausgaben',
    'doc.archive.filtre.annee': 'Jahr',
    'doc.archive.filtre.anneeToutes': 'Alle Jahre',
    'doc.archive.aucunResultat': 'Kein Eintrag entspricht diesem Filter.',
    ...
    'doc.archive.apercu.fermer': 'Schliessen',

...
const TEXTES_COCKPIT = {
  fr: {
    ...
    'table.tip.zebre': 'Colorer une ligne sur deux (ou une colonne sur deux)',
    'table.tip.separateurs': 'Filets horizontaux entre les lignes',
    'table.tip.total': 'Mettre la ou les lignes sélectionnées en évidence comme total',
    'table.tip.accent': 'Aperçu en gris ou avec la couleur annuelle du numéro (le PDF suit ausgabe.yaml)',
    ...
    'table.tip.styleEntete': 'Apparence des cellules d’en-tête',
  ...
  de: {
    ...
    'table.aide': 'Klicken Sie eine Zelle zum Bearbeiten (Ctrl+B fett, Ctrl+I kursiv). Tab/Enter zum Wechseln der Zelle, Ctrl+Z/Ctrl+Y für Rückgängig/Wiederholen, Ctrl+V zum Einfügen einer Tabelle (Excel). Umschalt+Klick oder Ziehen = rechteckiger Bereich. Kopfzeilen A/B/C und 1/2/3: anklicken zum Auswählen, ziehen zum Umordnen. Rechtsklick zum Einfügen, Löschen, Verbinden oder Teilen.',
    ...
    'table.tip.zebre': 'Jede zweite Zeile (oder Spalte) einfärben',
    'table.tip.separateurs': 'Waagrechte Linien zwischen den Zeilen',
    'table.tip.total': 'Ausgewählte Zeile(n) als Summe hervorheben',
    'table.tip.accent': 'Vorschau in Grau oder mit der Jahresfarbe der Ausgabe (das PDF folgt ausgabe.yaml)',
    ...
    'table.tip.styleEntete': 'Aussehen der Kopfzellen',

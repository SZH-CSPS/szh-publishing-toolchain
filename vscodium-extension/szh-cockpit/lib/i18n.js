...
const TEXTES_COCKPIT = {
  fr: {
    ...
    'ojs.err.doi': 'DOI absent. Un article publié sans DOI n’a pas d’identifiant pérenne et ne part pas chez Crossref ; cela ne se répare pas après coup.',
    ...
    'ojs.avert.doi.forme': 'DOI « {0} » : forme inattendue pour cette revue, attendue comme « {1} » — vérifiez la lettre de revue, l’année et le numéro.',
    ...
    'art.doi.fiche.autre': 'La fiche de cet article porte un autre DOI, « {0} » : c’est celui-là qui partira vers OJS. Corrigez-le, ou déplacez l’article au rang qui lui correspond.',
  ...
  de: {
    ...
    'ojs.err.doi': 'DOI fehlt. Ein ohne DOI publizierter Artikel hat keinen dauerhaften Identifikator und geht nicht an Crossref; das lässt sich nachträglich nicht beheben.',
    ...
    'ojs.avert.doi.forme': 'DOI « {0} »: unerwartete Form für diese Zeitschrift, erwartet wie « {1} » — prüfen Sie Zeitschriftenbuchstabe, Jahr und Nummer.',
    ...
    'art.doi.fiche.autre': 'Das Datenblatt dieses Artikels trägt einen anderen DOI, « {0} »: dieser geht an OJS. Korrigieren Sie ihn, oder setzen Sie den Artikel an die passende Position.',

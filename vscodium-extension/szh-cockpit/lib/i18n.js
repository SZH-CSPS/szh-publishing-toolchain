...
const TEXTES_COCKPIT = {
  fr: {
    ...
    'ojs.avert.citations.aucune': 'aucune liste de références repérée dans le .md — <citations> omis.',
    ...
    'ctl.import.tableau-sans-entete': 'Le tableau {0} de cet article n’a pas de rangée d’en-tête. Ouvrez-le dans l’éditeur de tableaux et désignez sa première rangée comme en-tête (clic droit). Sans elle, un lecteur d’écran ne peut pas dire à quelle colonne appartient une cellule.',
  ...
  de: {
    ...
    'ojs.avert.citations.aucune': 'keine Literaturliste im .md erkannt — <citations> weggelassen.',
    ...
    'ctl.import.tableau-sans-entete': 'Tabelle {0} dieses Artikels hat keine Kopfzeile. Öffnen Sie sie im Tabellen-Editor und legen Sie die erste Zeile als Kopfzeile fest (Rechtsklick). Ohne sie kann ein Screenreader nicht sagen, zu welcher Spalte eine Zelle gehört.',

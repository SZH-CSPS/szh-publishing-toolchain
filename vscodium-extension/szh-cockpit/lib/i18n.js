...
const TEXTES_COCKPIT = {
  fr: {
    ...
    'verif.note': 'À vérifier ici : l’exactitude. Le formel est déjà tenu par la compilation.',
    'verif.legende': 'Les séparateurs entre les groupes (@ . - /) sont les caractères réels de la valeur ; l’espacement, lui, est ajouté pour la lecture. ORCID et ROR sont affichés sans leur adresse en tête. LEER signale un champ vide.',
    'verif.signature': 'Vérifié par',
    ...
    'verif.section.auteurs': 'Auteur·e·s',
    'verif.section.auteur': 'Auteur·e',
  ...
  de: {
    ...
    'verif.note': 'Hier zu prüfen: die Richtigkeit. Das Formale hält die Kompilierung bereits.',
    'verif.legende': 'Die Trennzeichen zwischen den Gruppen (@ . - /) sind die tatsächlichen Zeichen des Werts; der Abstand dagegen ist zum Lesen eingefügt. ORCID und ROR werden ohne ihre vorangestellte Adresse angezeigt. LEER kennzeichnet ein leeres Feld.',
    'verif.signature': 'Geprüft von',
    ...
    'verif.section.auteurs': 'Autor·innen',
    'verif.section.auteur': 'Autor·in',
    ...
    'ctl.reimport.sans-article': 'Kein Artikel dieser Ausgabe passt zu diesem Word-Dokument. Es wurde nichts angetastet. Ist es ein neuer Artikel, ziehen Sie die Datei auf die Leiste «Zeitschrift SZH», und sie wird importiert; ist es die korrigierte Fassung eines Artikels, dessen Dateiname sich geändert hat, starten Sie «Artikel neu importieren» beim Artikel und weisen Sie ihm diese Datei zu.',
    'ctl.reimport.sans-word': 'Die Word-Datei dieses Artikels wartet nicht in der Ausgabe: es gibt nichts neu zu importieren, und es wurde nichts angetastet. Legen Sie die korrigierte Fassung unter demselben Dateinamen auf der Leiste «Zeitschrift SZH» ab und versuchen Sie es erneut.',

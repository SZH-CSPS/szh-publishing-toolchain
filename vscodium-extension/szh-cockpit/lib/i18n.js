...
const TEXTES_COCKPIT = {
  fr: {
    ...
    'arbre.reserve': 'Réserve',
    'arbre.reserve.tooltip': 'Fiches mises de côté et fiches reçues de la revue sœur – clic = ouvrir la réserve',
    ...
    'err.edition.refusee': 'l’éditeur a refusé la modification',
    'err.ecriture': 'Enregistrement impossible : {0} ({1}). Le fichier est peut-être ouvert dans un autre programme, ou OneDrive est en train de le synchroniser : attendez quelques secondes et réessayez.',
    ...
    'exportOjs.refus': 'Export refusé : {0} point(s) à corriger.',
    ...
    'ojs.err.pagination.perimee': 'La pagination du numéro n’est plus à jour pour {0}. Les folios imprimés et l’intervalle de pages envoyé à OJS ne concorderaient plus. Cliquez sur « Rafraîchir la pagination », puis relancez l’export.',
    'pagination.confirmer': '{0} articles, pages 1 à {1}. {2} PDF à recompiler.',
    'pagination.confirmer.bouton': 'Rafraîchir',
    'pagination.gele': 'Ce numéro est verrouillé ou archivé : ses folios sont ceux qui ont été publiés, ils ne se recalculent plus.',
    'pagination.fait': 'Pagination à jour : pages 1 à {0}.',
    'pagination.dejaajour': 'La pagination est déjà à jour : pages 1 à {0}. Rien à recompiler.',
    'pagination.trous': 'Des articles ne sont pas encore compilés : {0}. Compilez le numéro, puis rafraîchissez la pagination.',
    'pagination.echec': 'La pagination n’a pas pu être rafraîchie. Le détail est dans le journal de compilation.',
    ...
    'arbre.biblio.tip': 'Les références de cet article, une par paragraphe. Un clic les ouvre avec leur rendu à côté ; Ctrl+Alt+P montre ou cache ce rendu. Le titre est posé à la composition.',
    'biblio.apercu.absent': 'Le rendu du Markdown n’est pas disponible dans cet éditeur ; le texte reste ouvert seul.',
    'biblio.aucune': 'L’article {0} n’a pas de fichier de bibliographie : ses références sont peut-être encore dans son texte.',
    ...
    'meta.livre.ouvrage': 'Type d’ouvrage',
    'meta.livre.ouvrage.monographie': 'Monographie (un seul auteur ou une seule équipe pour tout le livre)',
    'meta.livre.ouvrage.collectif': 'Ouvrage collectif (chaque chapitre a ses propres auteur·e·s)',
    'meta.livre.langue': 'Langue du texte',
    'meta.livre.maquette': 'Maquette',
    'meta.livre.maquette.normal': 'Normale (charte courante)',
    'meta.livre.maquette.falc': 'Facile à lire et à comprendre (FALC)',
    'meta.livre.format': 'Format',
    'meta.livre.format.standard': 'Standard (155 × 225 mm)',
    'meta.livre.format.a4': 'A4 (210 × 297 mm)',
    'meta.livre.collection': 'Collection',
    'meta.livre.tome': 'Tome',
    'meta.livre.annee': 'Année de parution',
    'meta.livre.isbnPrint': 'ISBN papier',
    'meta.livre.isbnEbook': 'ISBN numérique',
    'meta.livre.doi': 'DOI',
    'meta.livre.licence': 'Licence',
    'meta.livre.licence.aucune': '(non définie)',
    'meta.livre.couleur': 'Couleur d’accent',
    'meta.livre.grammage': 'Grammage du papier (g/m²)',
    'meta.livre.main': 'Main du papier (volume, ex. 1.22)',
    'meta.livre.dosMm': 'Dos imposé (mm) – laisser vide pour le calcul automatique',
    'meta.livre.fondPerduMm': 'Fond perdu (mm)',
    'meta.livre.traitsDeCoupe': 'Traits de coupe',
    'meta.livre.profilCmjn': 'Profil CMJN (nom de fichier .icc, pour l’impression)',
    ...
    'verif.consigne': 'Imprimez avec Ctrl+P, format A4 – une page par article, et jamais deux articles sur la même feuille. La compilation refuse déjà un champ vide dans la langue de l’article, une marque de traduction restée en place et un DOI mal formé : cette feuille sert à vérifier l’exactitude, c’est-à-dire ce que la machine ne peut pas voir. Ce cadre ne s’imprime pas.',
    'verif.empreinte': 'empreinte',
    'verif.tous.tip': 'Tirer la feuille de relecture de tout le numéro : une page A4 par article, à imprimer.',
    'verif.nonenregistre': 'Le formulaire « Métadonnées des articles » porte des modifications non enregistrées. Enregistrez-les d’abord : la feuille se lit du disque, et elle dirait autre chose que ce que vous avez sous les yeux.',
    'verif.section.identification': 'Identification',
    'verif.section.textes': 'Textes',
    'verif.section.motscles': 'Mots-clés',
    'verif.section.auteurs': 'Autrices et auteurs',
    'verif.doi.calcule': 'calculé',
    'verif.doi.manuel': 'saisi à la main',
    'verif.aucun': 'Aucun article à vérifier dans ce numéro.',
    'verif.ouverte': 'Feuille de vérification ouverte dans le navigateur – {0} article(s). Imprimez-la avec Ctrl+P.',
    'verif.err': 'La feuille de vérification n’a pas pu être écrite : {0}. Réessayez ; si cela se reproduit, signalez-le.',
    ...
    'art.ordre.terminer.tip': 'Renommer les dossiers pour qu’ils portent le rang affiché, et enregistrer l’ordre.',
    'art.ordre.annuler': 'Annuler',
    'art.ordre.annuler.tip': 'Revenir à l’ordre enregistré. Aucun dossier n’a été touché.',
    ...
    'trad.vue.tout.detail': 'Revenir en arrière se fait bloc par bloc, dans le suivi de chaque article.',
    ...
    'trad.commentaire.aide': 'Cette note s’affiche sur la carte de l’article, pour toute l’équipe : une question à poser, un terme à trancher, un choix à expliquer.',
    ...
    'palette.noteBasPage': 'Note de bas de page',
    ...
    'info.deja.archivee': 'Ce numéro est déjà archivé. Si son dossier est resté parmi les numéros en cours, c’est que le déplacement n’a pas abouti.',
    'info.deja.archivee.livre': 'Ce livre est déjà archivé. Si son dossier est resté parmi les livres en cours, c’est que le déplacement n’a pas abouti.',
    ...
    'avert.out.suppression': 'Les documents produits n’ont pas pu être supprimés ({0}). L’archivage continue : ils seront retirés une fois cette fenêtre fermée.',
    'arch.ranger.bouton': 'Ranger le dossier',
    ...
    'ressource.horsarticle': 'Ouvrez d’abord un article pour y gérer les livres, films et autres ressources.',
    'ressource.section.livre': 'Livres',
    'ressource.section.film': 'Films',
    'ressource.section.intervention': 'Interventions parlementaires',
    'ressource.section.recherche': 'Recherches en cours',
    ...
    'ressource.ajouter.film.tip': 'Ajouter une nouvelle fiche de film',
    'ressource.ajouter.intervention': 'Ajouter une intervention',
    'ressource.ajouter.intervention.tip': 'Ajouter une nouvelle fiche d’intervention parlementaire',
    ...
    'ressource.champ.descriptif': 'Descriptif',
    'ressource.champ.descriptif.indice': 'Présente en quelques phrases la ressource',
    'ressource.champ.lien': 'Lien (facultatif)',
    'ressource.champ.lien.indice': 'https://…',
    'ressource.champ.image': 'Image',
    'ressource.champ.auteurs': 'Auteur(s)',
    'ressource.champ.annee': 'Année',
    'ressource.champ.editeur': 'Éditeur',
    'ressource.champ.realisateur': 'Réalisateur·rice',
    'ressource.champ.genre': 'Genre',
    'ressource.champ.pays': 'Pays',
    'ressource.champ.canton': 'Canton',
    'ressource.champ.categorie': 'Type d’intervention',
    'ressource.champ.numero': 'Numéro',
    'ressource.champ.date': 'Date',
    'ressource.champ.institutions': 'Institution(s) de recherche',
    'ressource.champ.debut': 'Début',
    'ressource.champ.fin': 'Fin',
    'ressource.section.reprise': 'D’une revue à l’autre',
    'ressource.ajouter.reprise': 'Ajouter une reprise',
    'ressource.ajouter.reprise.tip': 'Ajouter la reprise d’un article paru dans la revue sœur',
    'ressource.champ.revue': 'Revue',
    'ressource.champ.reference': 'Référence (volume, numéro, pages)',
    ...
    'ressource.ajouter.agenda.tip': 'Ajouter une manifestation, un cours ou une formation continue',
    'ressource.champ.evenement': 'Type d’événement',
    'ressource.champ.lieu': 'Lieu',
    'ressource.champ.organisateur': 'Organisateur·rice',
    'ressource.option.vide': '–',
    'ressource.option.evenement.colloque': 'Colloque',
    'ressource.option.evenement.congres': 'Congrès',
    'ressource.option.evenement.journee': 'Journée d’étude',
    'ressource.option.evenement.cours': 'Cours',
    'ressource.option.evenement.webinaire': 'Webinaire',
    'ressource.option.evenement.formation': 'Formation continue',
    ...
    'doc.groupe.fiches': 'Fiches',
    'doc.badge.incomplet': 'non complet',
    'doc.badge.vide': 'vide',
    'doc.enregistrer.tip': 'Écrire les fiches et les rubriques dans la page (Ctrl+S)',
    ...
    'ressource.envoye': '✓ Copie envoyée à traduire',

    // ── Rubriques de texte riche d'un article de Documentation ─────────────────
    'rubrique.section.dossier-references': 'Références du dossier',
    'rubrique.section.dossier-liens': 'Sites en lien avec le dossier',
    'rubrique.section.tour-horizon': 'Tour d’horizon',
    'rubrique.section.ressources': 'Ressources',
    'rubrique.section.podcasts': 'Documentaires et podcasts',
    'rubrique.champ.contenu': 'Texte',
    'rubrique.champ.contenu.indice': 'Une entrée par paragraphe. Ligne vide = nouveau paragraphe.',
    'rubrique.gras': 'Gras',
    'rubrique.gras.tip': 'Mettre la sélection en gras (Ctrl+B)',
    'rubrique.italique': 'Italique',
    'rubrique.italique.tip': 'Mettre la sélection en italique (Ctrl+I)',
    'rubrique.lien': 'Lien',
    'rubrique.lien.tip': 'Faire de la sélection un lien',
    'rubrique.liste': 'Liste',
    'rubrique.liste.tip': 'Mettre les lignes sélectionnées en liste à puces',

    // ── Réserve : fiches mises de côté, et échanges entre les deux revues ──────
    'reserve.titre': 'Réserve',
    'reserve.vide': 'La réserve est vide. Les fiches mises de côté et celles reçues de la revue sœur apparaissent ici.',
    'reserve.compte': '{0} fiche(s) en réserve',
    'reserve.atraduire': 'à traduire',
    'reserve.origine': 'de la {0}, numéro {1}',
    'reserve.depose.le': 'mise en réserve le {0}',
    'reserve.inserer': 'Insérer dans cet article',
    'reserve.inserer.tip': 'Écrire cette fiche dans l’article ouvert et la retirer de la réserve',
    'reserve.inserer.horsarticle': 'Ouvrez d’abord l’article de Documentation qui doit recevoir la fiche.',
    'reserve.insere': '✓ Fiche insérée dans l’article',
    'reserve.supprimer': 'Supprimer',
    'reserve.supprimer.tip': 'Supprimer définitivement cette fiche de la réserve',
    'reserve.supprimer.question': 'Supprimer définitivement cette fiche de la réserve ?',
    'reserve.supprime': 'Fiche supprimée de la réserve.',
    'reserve.err.ecriture': 'La réserve n’a pas pu être écrite : {0}',
    'reserve.nom.revue': 'Revue',
    'reserve.nom.zeitschrift': 'Zeitschrift',
    'ressource.image.absente': 'Aucune image',
    'ressource.image.deposee': '✓ Image déposée',
    ...
    'nouv.titre': 'Quoi de neuf',
    'nouv.version': 'Version installée : {0}.',
    'nouv.rien': 'Rien de nouveau à signaler pour cette version.',
    'nouv.invite': 'Pronto a été mis à jour. Voulez-vous voir ce qui a changé ?',
    'nouv.invite.bouton': 'Voir les nouveautés',
    'demarrage.barre': 'SZH…',
    ...
    'regl.modeTrad': 'Mode « Trad » – relire les textes de l’outil',
    'regl.modeTrad.actif': 'Activé',
    'regl.modeTrad.inactif': 'Désactivé',
    'regl.modeTrad.aide': 'Allumé, un clic sur un texte d’un panneau n’exécute plus l’action normale : il ouvre le formulaire de suggestion sur ce texte. Ce formulaire de réglages fait exception, et Échap éteint le mode.',
    ...
    'regl.suggInterface': '{0} suggestion(s) en attente de relecture.',
    'regl.suggInterface.aucune': 'Aucune suggestion en attente.',
    'regl.suggInterface.ouvrir': 'Ouvrir le dossier',
    'regl.suggInterface.aide': 'Un fichier par suggestion, sur ce poste. Transmettez-les à la personne qui administre l’outil : les corriger ici ne change pas l’interface.',
    ...
    'regl.exportLangue.aide': 'Tous les textes du cockpit, français et allemand côte à côte, pour la personne qui les relit.',
    ...
    'sugg.aide': 'Une proposition ne remplace rien : le texte publié ne bouge pas tant que personne n’a tranché.',
    ...
    'sugg.cle': 'Libellé',
    'sugg.cle.inconnue': 'non retrouvé',
    'sugg.cle.inconnue.aide': 'Ce texte n’a pas été retrouvé parmi les libellés de l’outil. La suggestion est enregistrée telle quelle.',
    'sugg.cle.plusieurs': 'Plusieurs libellés portent ce texte : choisissez celui que vous êtes en train de relire.',
    ...
    'action.medias': 'Décrire les images',
    'action.medias.tip': 'Ouvrir le formulaire des images de cet article.',
    'action.numero': 'Métadonnées du numéro',
    'action.numero.tip': 'Ouvrir les métadonnées du numéro.',
    'action.reglages': 'Ouvrir les réglages',
    'action.reglages.tip': 'Ouvrir les réglages du poste.',
    'action.word': 'Voir les Word en attente',
    'action.word.tip': 'Ouvrir la liste des documents Word déposés.',
    'action.documentation': 'Ouvrir la Documentation',
    ...
    'detail.dossier-espaces': 'Renommez le dossier sans espaces : la chaîne ne sait pas les suivre.',
    'detail.pagination-perimee': 'Les folios de cet article ne suivent plus l’ordre du numéro. Rafraîchissez la pagination avant d’exporter.',
    'defaut.aucun-article': 'Aucun article dans ce numéro',
    'defaut.pas-une-revue': 'Ce dossier n’est pas un numéro',
    'defaut.profil-rien': 'Numéro réglé pour ne rien produire',
    'defaut.profil-differe': 'Mode de production encore indisponible',
    'defaut.profil-inconnu': 'Profil de production inconnu',
    'defaut.pdf-verrouille': 'PDF ouvert dans une autre application',
    'detail.pdf-verrouille': 'Fermez-le (Adobe Reader, aperçu), puis enregistrez à nouveau.',
    'defaut.balisage-simple': 'PDF au balisage simple',
    'defaut.balisage-aucun': 'PDF sans balisage',
    'defaut.image-manquante': 'Image introuvable',
    ...
    'defaut.champ-vide': 'Champ vide dans la langue de l’article',
    'defaut.marque-champ': 'Marque de traduction restée dans un champ',
    'defaut.marque-motcle': 'Marque de traduction restée sur un mot-clé',
    'defaut.sans-langue': 'Langue de l’article non déclarée',
    'defaut.langue-inconnue': 'Langue inconnue de la revue',
    'defaut.figure-sans-alt': 'Figure sans texte alternatif',
    'defaut.image-sans-legende': 'Image sans légende',
    'defaut.aucun-pdf': 'Aucun PDF compilé',
    'defaut.pdfua-non-conforme': 'PDF non conforme PDF/UA',
    'ressource.champ.distributeur': 'Distributeur',
    'detail.pdfua-non-conforme': '{0} règle(s) ne sont pas respectées.',
    'defaut.pdfua-regle': 'Règle PDF/UA non respectée',
    'defaut.pdfua-outillage': 'Validateur PDF/UA sans verdict',
    'defaut.appel-sans-reference': 'Appel sans référence',
    'defaut.appel-ambigu': 'Appel ambigu',
    'defaut.reference-orpheline': 'Référence jamais citée',
    'defaut.ancrage-inconnu': 'Lien vers une référence disparue',
    'defaut.caractere-sans-repli': 'Caractère sans équivalent simple',
    'defaut.bilan': 'Bilan des citations',
    'defaut.import-echec': 'Word non converti',
    'defaut.import-restes': 'Word encore en attente',
    'defaut.tableau-sans-entete': 'Tableau sans en-tête',
    'defaut.langue-deduite': 'Langue déduite du document',
    ...
    'defaut.pronto-cle-absente': 'Champ du gabarit laissé vide',
    'defaut.pronto-type-inconnu': 'Type d’article non reconnu',
    'defaut.pronto-structure': 'Gabarit non suivi',
    'defaut.pronto-bloc-ancien': 'Bloc à l’ancienne forme',
    ...
    'defaut.credit-photo-non-repris': 'Crédit de photo non repris',
    'defaut.reimport-sans-article': 'Aucun article ne correspond à ce Word',
    'defaut.reimport-sans-word': 'Aucun Word corrigé en attente',
    'defaut.reimport-fiche-sans-source': 'Document d’origine inconnu',
    'defaut.reimport-plusieurs-articles': 'Plusieurs articles pour un même Word',
    'defaut.reimport-echec': 'Remplacement du texte arrêté',
    'defaut.reimport-panne': 'Remplacement du texte en panne',
    'defaut.reimport-interrompu': 'Remplacement du texte interrompu',
    'defaut.reimport-reprise-impossible': 'Reprise impossible',
    'defaut.reimport-reprise': 'Remplacement repris et terminé',
    'defaut.annuler-sans-etat': 'Aucun texte d’avant conservé',
    'defaut.fiche-differente': 'Fiche et Word divergent',
    'detail.fiche-differente': 'Le Word corrigé ne dit pas la même chose que la fiche : titre, sous-titre ou auteurs. La fiche n’a pas été touchée.',
    'defaut.tableau-conflit': 'Tableaux retravaillés puis réimportés',
    'detail.tableau-conflit': 'Les tableaux corrigés ici ont été remplacés par ceux du Word. À vérifier.',
    'defaut.tableaux-inconnus': 'État des tableaux inconnu',
    'defaut.image-perdue': 'Images non rapportées par le Word',
    'detail.image-perdue': 'Elles étaient dans l’article et le Word corrigé ne les rapporte pas : elles sont restées en place.',
    'defaut.corps-retravaille': 'Texte retouché depuis l’import',
    'detail.corps-retravaille': 'Les retouches faites ici ont été remplacées par le texte du Word.',
    'defaut.biblio-conflit': 'Références retravaillées puis réimportées',
    ...
    // La scission d'un manuscrit de livre en chapitres (livre-scinder.py).
    'defaut.scission-aucun-titre': 'Aucun titre de chapitre trouvé',
    'defaut.scission-chapitre-existe': 'Dossier de chapitre déjà pris',
    'defaut.scission-image-introuvable': 'Image introuvable à la scission',
    'defaut.scission-tableau-introuvable': 'Tableau introuvable à la scission',
    'defaut.scission-liminaire-texte-non-repris': 'Texte de tête non repris dans un chapitre',
    'defaut.scission-liminaire-texte-media-introuvable': 'Média du texte de tête introuvable',
    'defaut.scission-liminaire-media-introuvable': 'Média d’une pièce liminaire introuvable',
    'defaut.scission-source-non-supprimee': 'Dossier d’origine conservé après la scission',
    ...
    'defaut.sans-fiche': 'Article sans fiche de métadonnées',
    'defaut.doi-double': 'DOI porté par deux articles',
    ...
    'ctl.source.typo': 'Typographie',
    'ctl.source.metafichier': 'Images natives Word',
    ...
    'ctl.import.pronto-cle-absente': 'Le champ « {0} » du gabarit n’a pas été rempli. Rien n’est perdu – mais rien n’a été repris dans la fiche non plus.',
    'ctl.import.pronto-type-inconnu': 'Le champ « Type d’article » porte « {0} », que le gabarit ne propose pas. Le type est resté vide : choisissez-le dans « Métadonnées des articles ».',
    'ctl.import.pronto-structure': 'Ce document ne suit pas la forme du gabarit « Pronto » : un des deux tableaux attendus en tête est introuvable. Rien n’a été lu automatiquement ; complétez la fiche à la main, ou repartez du gabarit.',
    'ctl.import.pronto-bloc-ancien': 'Le tableau {0} est un bloc figure ou tableau à l’ancienne forme. Il s’imprimera tel quel, avec ses étiquettes, et sa légende ne sera ni numérotée ni reprise comme texte alternatif. Convertissez-le au prochain passage sur le document.',
    'ctl.import.pronto-bloc-vide': 'Un bloc annonce la légende « {0} » mais ne porte ni image ni tableau : le dépôt est resté vide. Complétez-le dans le document Word, puis réimportez l’article.',
    'ctl.import.pronto-cles-sans-contenu': 'Des clés de figure ou de tableau ont été trouvées (légende « {0} »), mais ni image ni tableau ne les suit : elles restent telles quelles dans le texte. Vérifiez leur position par rapport à l’image ou au tableau dans le document.',
    'ctl.import.pronto-bloc-mal-forme': 'Le tableau {0} porte les étiquettes d’une figure ou d’un tableau sans en avoir la forme. Il n’a pas été lu comme un bloc et s’imprimera tel quel. Ouvrez le document Word et repartez du bloc du gabarit.',
    'ctl.import.pronto-blocs-colles': '{0} blocs figure ou tableau se touchaient dans le document et ont fusionné à la conversion. Ils ont quand même été reconnus séparément ; laissez une ligne vide entre deux blocs pour éviter ce piège.',
    'ctl.import.pronto-biblio-tableau': 'Un tableau se trouve juste après le titre « {0} » : la bibliographie s’arrête là. Vérifiez que toutes les références ont bien été reprises.',
  ...
  de: {
    ...
    'arbre.reserve': 'Reserve',
    'arbre.reserve.tooltip': 'Zurückgelegte Einträge und Einträge aus der Schwesterzeitschrift – Klick = Reserve öffnen',
    ...
    'statut.supprime.renumerote': 'Artikel «{0}» gelöscht, und {1} Ordner neu nummeriert.',
    'art.suppr.renumerote.echec': 'Der Artikel ist gelöscht, aber nicht alle verbleibenden Ordner konnten neu nummeriert werden ({0}). Richten Sie sie über «Reihenfolge ändern» neu aus.',
    ...
    'err.edition.refusee': 'der Editor hat die Änderung abgelehnt',
    'err.ecriture': 'Speichern nicht möglich: {0} ({1}). Die Datei ist vielleicht in einem anderen Programm geöffnet, oder OneDrive synchronisiert sie gerade: warten Sie einige Sekunden und versuchen Sie es erneut.',
    ...
    'exportOjs.refus': 'Export abgelehnt: {0} Punkt(e) zu korrigieren.',
    ...
    'regl.proteges.bloc.tachesArticle': 'Aufgaben pro Artikel',
    ...
    'ojs.types.aide': 'Der im Datenblatt eines Artikels gewählte Typ bestimmt die Rubrik. Eine hinzugefügte Rubrik erscheint im Export erst, wenn sie hier zugewiesen ist.',
    ...
    'ojs.err.pagination.perimee': 'Die Paginierung der Ausgabe ist für {0} nicht mehr aktuell. Die gedruckten Seitenzahlen und der an OJS gesendete Seitenbereich würden nicht mehr übereinstimmen. Klicken Sie auf «Paginierung aktualisieren», und starten Sie den Export erneut.',
    'pagination.confirmer': '{0} Artikel, Seiten 1 bis {1}. {2} PDF werden neu kompiliert.',
    'pagination.confirmer.bouton': 'Aktualisieren',
    'pagination.gele': 'Diese Ausgabe ist gesperrt oder archiviert: ihre Seitenzahlen sind die veröffentlichten und werden nicht mehr neu berechnet.',
    'pagination.fait': 'Paginierung aktuell: Seiten 1 bis {0}.',
    'pagination.dejaajour': 'Die Paginierung ist bereits aktuell: Seiten 1 bis {0}. Nichts neu zu kompilieren.',
    'pagination.trous': 'Einige Artikel sind noch nicht kompiliert: {0}. Kompilieren Sie die Ausgabe, und aktualisieren Sie danach die Paginierung.',
    'pagination.echec': 'Die Paginierung konnte nicht aktualisiert werden. Die Einzelheiten stehen im Kompilierungsprotokoll.',
    ...
    'biblio.intro': 'Den Titel des Literaturverzeichnisses setzt der Satz, in der Sprache des Artikels. Die Bezeichnungen unten sind die der beiden Zeitschriften; sie hier zu ändern genügt, in den Artikeln ist nichts anzupassen.',
    'biblio.col.langue': 'Sprache des Artikels',
    'biblio.vide': 'kein Titel',
    'arbre.biblio': 'Literaturverzeichnis',
    'arbre.biblio.tip': 'Die Einträge dieses Artikels, einer pro Absatz. Ein Klick öffnet sie mit ihrer Vorschau daneben; Ctrl+Alt+P zeigt oder verbirgt diese Vorschau. Den Titel setzt der Satz.',
    'biblio.apercu.absent': 'Die Markdown-Vorschau steht in diesem Editor nicht zur Verfügung; der Text bleibt allein geöffnet.',
    'biblio.aucune': 'Der Artikel {0} hat keine Literaturverzeichnis-Datei: seine Einträge stehen vielleicht noch in seinem Text.',
    ...
    'meta.livre.soustitre': 'Untertitel',
    'meta.livre.ouvrage': 'Werkart',
    'meta.livre.ouvrage.monographie': 'Monografie (eine Autorenschaft für das ganze Buch)',
    'meta.livre.ouvrage.collectif': 'Sammelband (jedes Kapitel hat eigene Autor:innen)',
    'meta.livre.langue': 'Sprache des Textes',
    'meta.livre.maquette': 'Layoutvorlage',
    'meta.livre.maquette.normal': 'Normal (aktuelle Gestaltung)',
    'meta.livre.maquette.falc': 'Leicht Lesen (FALC)',
    'meta.livre.format': 'Format',
    'meta.livre.format.standard': 'Standard (155 × 225 mm)',
    'meta.livre.format.a4': 'A4 (210 × 297 mm)',
    'meta.livre.collection': 'Reihe',
    'meta.livre.tome': 'Band',
    'meta.livre.annee': 'Erscheinungsjahr',
    'meta.livre.isbnPrint': 'ISBN Print',
    'meta.livre.isbnEbook': 'ISBN E-Book',
    'meta.livre.doi': 'DOI',
    'meta.livre.licence': 'Lizenz',
    'meta.livre.licence.aucune': '(nicht festgelegt)',
    'meta.livre.couleur': 'Akzentfarbe',
    'meta.livre.grammage': 'Papiergewicht (g/m²)',
    'meta.livre.main': 'Papierdicke (Volumen, z. B. 1.22)',
    'meta.livre.dosMm': 'Vorgegebener Rücken (mm) – leer lassen für automatische Berechnung',
    'meta.livre.fondPerduMm': 'Beschnittzugabe (mm)',
    'meta.livre.traitsDeCoupe': 'Schnittmarken',
    'meta.livre.profilCmjn': 'CMYK-Profil (.icc-Dateiname, nur für den Druck)',
    ...
    'verif.consigne': 'Drucken Sie mit Strg+P, Format A4 – eine Seite pro Artikel, und nie zwei Artikel auf demselben Blatt. Die Kompilierung weist ein leeres Feld in der Sprache des Artikels, eine stehengebliebene Übersetzungsmarke und eine fehlerhafte DOI bereits zurück: Dieses Blatt dient der Prüfung der Richtigkeit, also dessen, was die Maschine nicht sehen kann. Dieser Kasten wird nicht gedruckt.',
    'verif.empreinte': 'Prüfzeichen',
    'verif.tous.tip': 'Das Prüfblatt der ganzen Ausgabe erstellen: eine A4-Seite pro Artikel, zum Ausdrucken.',
    'verif.nonenregistre': 'Das Formular «Metadaten der Artikel» enthält nicht gespeicherte Änderungen. Speichern Sie sie zuerst: Das Blatt wird von der Festplatte gelesen und würde etwas anderes zeigen als das, was Sie vor sich haben.',
    'verif.section.identification': 'Identifikation',
    'verif.section.textes': 'Texte',
    'verif.section.motscles': 'Schlagwörter',
    'verif.section.auteurs': 'Autorinnen und Autoren',
    'verif.doi.calcule': 'berechnet',
    'verif.doi.manuel': 'von Hand erfasst',
    'verif.aucun': 'In dieser Ausgabe gibt es keinen Artikel zu prüfen.',
    'verif.ouverte': 'Prüfblatt im Browser geöffnet – {0} Artikel. Drucken Sie es mit Strg+P.',
    'verif.err': 'Das Prüfblatt konnte nicht geschrieben werden: {0}. Versuchen Sie es erneut; wiederholt sich das, melden Sie es.',
    ...
    'art.ordre.terminer.tip': 'Die Ordner so umbenennen, dass sie den angezeigten Rang tragen, und die Reihenfolge speichern.',
    'art.ordre.annuler': 'Abbrechen',
    'art.ordre.annuler.tip': 'Zur gespeicherten Reihenfolge zurück. Kein Ordner wurde verändert.',
    ...
    'art.doi.forme': 'Der angezeigte DOI wurde von Hand festgelegt, entspricht aber nicht der Schreibweise dieser Zeitschrift – eine korrekte Form sieht so aus: «{0}». Prüfen Sie Zeitschriftenbuchstabe, Jahr und Nummer in seinen Metadaten, oder deaktivieren Sie «DOI von Hand festlegen», um zur Berechnung zurückzukehren.',
    ...
    'trad.vue.tout.detail': 'Zurück geht es blockweise, im Verlauf des jeweiligen Artikels.',
    ...
    'trad.commentaire.aide': 'Diese Notiz erscheint auf der Artikelkarte, für das ganze Team: eine offene Frage, ein zu klärender Begriff, eine zu begründende Entscheidung.',
    ...
    'cit.toolkit.discordant': 'Ihr Satzwerkzeug und das Cockpit haben nicht die gleiche '
      ...
      + 'erneut.',
    'cit.toolkit.absent': 'Das SZH-Satzwerkzeug wurde auf diesem Arbeitsplatz nicht gefunden: '
    ...
    'etat.barre.tooltip.version': 'Erstellt mit Version {0} der Software (auf diesem Arbeitsplatz installiert: {1}).',
    ...
    'conflit.copie': 'OneDrive hat eine Datei dieser Ausgabe verdoppelt: «{0}». Zwei Arbeitsplätze haben sie gleichzeitig geschrieben, und eine der beiden Fassungen ist nicht in der Ausgabe.',
    ...
    'modale.deverrouiller.detail': 'Die Ausgabe wird wieder änderbar: der Editor verlässt den Schreibschutz und alle Aktionen der Leiste «Pronto» sind wieder aktiv.\n\nEine bereits veröffentlichte Ausgabe sollte sich grundsätzlich nicht mehr ändern – sperren Sie sie nach der Korrektur wieder.',
    ...
    'info.deja.archivee': 'Diese Ausgabe ist bereits archiviert. Wenn ihr Ordner bei den laufenden Ausgaben geblieben ist, hat das Verschieben nicht geklappt.',
    'info.deja.archivee.livre': 'Dieses Buch ist bereits archiviert. Wenn sein Ordner bei den laufenden Büchern geblieben ist, hat das Verschieben nicht geklappt.',
    ...
    'avert.out.suppression': 'Die erzeugten Dokumente konnten nicht gelöscht werden ({0}). Die Archivierung läuft weiter: sie werden entfernt, sobald dieses Fenster geschlossen ist.',
    'arch.ranger.bouton': 'Ordner ablegen',
    ...
    'ressource.horsarticle': 'Öffnen Sie zuerst einen Artikel, um dort Bücher, Filme und weitere Ressourcen zu verwalten.',
    'ressource.section.livre': 'Bücher',
    'ressource.section.film': 'Filme',
    'ressource.section.intervention': 'Parlamentarische Vorstösse',
    'ressource.section.recherche': 'Laufende Forschungsprojekte',
    ...
    'ressource.ajouter.film.tip': 'Einen neuen Filmeintrag hinzufügen',
    'ressource.ajouter.intervention': 'Vorstoss hinzufügen',
    'ressource.ajouter.intervention.tip': 'Einen neuen Eintrag für einen parlamentarischen Vorstoss hinzufügen',
    ...
    'ressource.champ.descriptif': 'Beschreibung',
    'ressource.champ.descriptif.indice': 'Stellt die Ressource in wenigen Sätzen vor',
    'ressource.champ.lien': 'Link (fakultativ)',
    'ressource.champ.lien.indice': 'https://…',
    'ressource.champ.image': 'Bild',
    'ressource.champ.auteurs': 'Autor(en)',
    'ressource.champ.annee': 'Jahr',
    'ressource.champ.editeur': 'Verlag',
    'ressource.champ.realisateur': 'Regie',
    'ressource.champ.genre': 'Genre',
    'ressource.champ.pays': 'Land',
    'ressource.champ.canton': 'Kanton',
    'ressource.champ.categorie': 'Art des Vorstosses',
    'ressource.champ.numero': 'Nummer',
    'ressource.champ.date': 'Datum',
    'ressource.champ.institutions': 'Forschende Institution(en)',
    'ressource.champ.debut': 'Beginn',
    'ressource.champ.fin': 'Ende',
    'ressource.section.reprise': 'Blick in die Revue',
    'ressource.ajouter.reprise': 'Beitrag hinzufügen',
    'ressource.ajouter.reprise.tip': 'Einen in der Schwesterzeitschrift erschienenen Beitrag hinzufügen',
    'ressource.champ.revue': 'Zeitschrift',
    'ressource.champ.reference': 'Fundstelle (Band, Nummer, Seiten)',
    'ressource.champ.doi': 'DOI',

    // ---- Der Eintrag « agenda »: Veranstaltungen und Weiterbildung ----
    'ressource.section.agenda': 'Weiterbildung und Veranstaltungen',
    'ressource.ajouter.agenda': 'Veranstaltung hinzufügen',
    'ressource.ajouter.agenda.tip': 'Eine Veranstaltung, einen Kurs oder eine Weiterbildung hinzufügen',
    'ressource.champ.evenement': 'Art der Veranstaltung',
    'ressource.champ.lieu': 'Ort',
    'ressource.champ.organisateur': 'Veranstalter:in',
    'ressource.option.vide': '–',
    'ressource.option.evenement.colloque': 'Tagung',
    'ressource.option.evenement.congres': 'Kongress',
    'ressource.option.evenement.journee': 'Fachtagung',
    'ressource.option.evenement.cours': 'Kurs',
    'ressource.option.evenement.webinaire': 'Webinar',
    'ressource.option.evenement.formation': 'Weiterbildung',
    ...
    'doc.groupe.rubriques': 'Rubriken',
    'doc.groupe.fiches': 'Einträge',
    'doc.badge.incomplet': 'unvollständig',
    'doc.badge.vide': 'leer',
    'doc.enregistrer.tip': 'Einträge und Rubriken in die Seite schreiben (Ctrl+S)',
    ...
    'doc.creee': '✓ Dokumentationsseite erstellt',
    'rubrique.vider.tip': 'Diesen Block leeren: die Rubrik wird nicht mehr gedruckt',
    'ressource.detacher.tip': 'Diesen Eintrag aus dem Artikel nehmen und in die Reserve legen',
    'ressource.envoyer.tip': 'Eine Kopie dieses Eintrags zur Übersetzung an {0} senden',
    'ressource.detache': '✓ Eintrag in die Reserve gelegt',
    'ressource.envoye': '✓ Kopie zur Übersetzung gesendet',

    // ── Rubriken mit Fliesstext eines Dokumentationsartikels ──────────────────
    'rubrique.section.dossier-references': 'Literatur zum Schwerpunkt',
    'rubrique.section.dossier-liens': 'Linksammlung zum Schwerpunkt',
    'rubrique.section.tour-horizon': 'Rundschau',
    'rubrique.section.ressources': 'Ressourcen',
    'rubrique.section.podcasts': 'Dokumentarfilme und Podcasts',
    'rubrique.champ.contenu': 'Text',
    'rubrique.champ.contenu.indice': 'Ein Eintrag pro Absatz. Leerzeile = neuer Absatz.',
    'rubrique.gras': 'Fett',
    'rubrique.gras.tip': 'Auswahl fett setzen (Ctrl+B)',
    'rubrique.italique': 'Kursiv',
    'rubrique.italique.tip': 'Auswahl kursiv setzen (Ctrl+I)',
    'rubrique.lien': 'Link',
    'rubrique.lien.tip': 'Aus der Auswahl einen Link machen',
    'rubrique.liste': 'Liste',
    'rubrique.liste.tip': 'Ausgewählte Zeilen als Aufzählung setzen',

    // ── Reserve: zurückgelegte Einträge und Austausch zwischen den Zeitschriften ──
    'reserve.titre': 'Reserve',
    'reserve.vide': 'Die Reserve ist leer. Zurückgelegte Einträge und solche aus der Schwesterzeitschrift erscheinen hier.',
    'reserve.compte': '{0} Eintrag/Einträge in der Reserve',
    'reserve.atraduire': 'zu übersetzen',
    'reserve.origine': 'aus der {0}, Ausgabe {1}',
    'reserve.depose.le': 'zurückgelegt am {0}',
    'reserve.inserer': 'In diesen Artikel einfügen',
    'reserve.inserer.tip': 'Diesen Eintrag in den offenen Artikel schreiben und aus der Reserve nehmen',
    'reserve.inserer.horsarticle': 'Öffnen Sie zuerst den Dokumentationsartikel, der den Eintrag aufnehmen soll.',
    'reserve.insere': '✓ Eintrag in den Artikel eingefügt',
    'reserve.supprimer': 'Löschen',
    'reserve.supprimer.tip': 'Diesen Eintrag endgültig aus der Reserve löschen',
    'reserve.supprimer.question': 'Diesen Eintrag endgültig aus der Reserve löschen?',
    'reserve.supprime': 'Eintrag aus der Reserve gelöscht.',
    'reserve.err.ecriture': 'Die Reserve konnte nicht geschrieben werden: {0}',
    'reserve.nom.revue': 'Revue',
    'reserve.nom.zeitschrift': 'Zeitschrift',
    'ressource.image.absente': 'Kein Bild',
    'ressource.image.deposee': '✓ Bild abgelegt',
    ...
    'nouv.titre': 'Was ist neu',
    'nouv.version': 'Installierte Version: {0}.',
    'nouv.rien': 'Für diese Version gibt es nichts Neues zu melden.',
    'nouv.invite': 'Pronto wurde aktualisiert. Möchten Sie sehen, was sich geändert hat?',
    'nouv.invite.bouton': 'Neuerungen ansehen',
    'demarrage.barre': 'SZH…',
    ...
    'regl.verifTrad.actif': 'Aktiv',
    'regl.verifTrad.inactif': 'Deaktiviert',
    'regl.modeTrad': 'Modus «Trad» – Texte des Werkzeugs gegenlesen',
    'regl.modeTrad.actif': 'Aktiv',
    'regl.modeTrad.inactif': 'Deaktiviert',
    'regl.modeTrad.aide': 'Ist er aktiv, führt ein Klick auf einen Text eines Panels nicht mehr die übliche Aktion aus: er öffnet das Vorschlagsformular zu diesem Text. Dieses Einstellungsformular ist ausgenommen, und Esc schaltet den Modus aus.',
    ...
    'regl.suggInterface': '{0} Vorschlag/Vorschläge warten auf Gegenlesen.',
    'regl.suggInterface.aucune': 'Keine Vorschläge offen.',
    'regl.suggInterface.ouvrir': 'Ordner öffnen',
    'regl.suggInterface.aide': 'Eine Datei pro Vorschlag, auf diesem Arbeitsplatz. Leiten Sie sie an die Person weiter, die das Werkzeug betreut: hier zu korrigieren ändert die Oberfläche nicht.',
    ...
    'regl.exportLangue.aide': 'Alle Texte des Cockpits, Französisch und Deutsch nebeneinander, für die Person, die sie gegenliest.',
    'regl.exportLangue.faite': 'Sprachdatei in «{0}» gespeichert.',
    'regl.exportLangue.echec': 'Sprachdatei nicht gespeichert: {0} ({1}).',
    'regl.exportLangue.lire': 'Diese Datei ist eine KOPIE der Texte des Cockpits: sie zu korrigieren ändert nichts an der Oberfläche. Schicken Sie sie der Person zurück, die das Werkzeug betreut.',
    'sugg.pastille': 'Eine andere Übersetzung für dieses Feld vorschlagen',
    'sugg.titre': 'Übersetzung vorschlagen',
    'sugg.titre.un': 'Übersetzung vorschlagen – {0}',
    'sugg.article': 'Artikel',
    'sugg.champ': 'Feld',
    'sugg.langue': 'Sprache',
    'sugg.actuel': 'Aktueller Text',
    'sugg.actuel.vide': '(leer)',
    'sugg.propose': 'Vorgeschlagene Übersetzung',
    'sugg.commentaire': 'Warum?',
    'sugg.commentaire.aide': 'Ein Missverständnis, ein hauseigener Begriff, eine klarere Formulierung.',
    'sugg.aide': 'Ein Vorschlag ersetzt nichts: der veröffentlichte Text bleibt stehen, bis jemand entschieden hat.',
    'sugg.enregistrer': 'Vorschlag speichern',
    'sugg.supprimer': 'Löschung dieses Textes vorschlagen',
    'sugg.supprimer.quoi': 'Wird gespeichert: dieser Text sollte nicht bestehen. Es wird keine Übersetzung an seiner Stelle vorgeschlagen.',
    'sugg.annuler': 'Abbrechen',
    'sugg.rien': 'Nichts vorzuschlagen: weder Änderung noch Kommentar.',
    'sugg.enregistree': 'Vorschlag gespeichert: {0}',
    'sugg.err.ecriture': 'Der Vorschlag konnte nicht geschrieben werden: {0}',
    'sugg.err.champ': 'Dieses Feld wird nicht übersetzt.',
    'sugg.champ.title': 'Titel',
    'sugg.champ.subtitle': 'Untertitel',
    'sugg.champ.resume': 'Zusammenfassung',
    'sugg.champ.keywords': 'Schlagwörter',
    'sugg.titre.interface': 'Übersetzung vorschlagen – Text des Werkzeugs',
    'sugg.cible': 'Text',
    'sugg.cible.interface': 'Text der Oberfläche des Werkzeugs',
    'sugg.cle': 'Beschriftung',
    'sugg.cle.inconnue': 'nicht gefunden',
    'sugg.cle.inconnue.aide': 'Dieser Text wurde unter den Beschriftungen des Werkzeugs nicht gefunden. Der Vorschlag wird trotzdem gespeichert.',
    'sugg.cle.plusieurs': 'Mehrere Beschriftungen tragen diesen Text: wählen Sie die, die Sie gerade gegenlesen.',
    ...
    'action.medias': 'Bilder beschreiben',
    'action.medias.tip': 'Die Bildverwaltung dieses Artikels öffnen.',
    'action.numero': 'Metadaten der Ausgabe',
    'action.numero.tip': 'Die Metadaten der Ausgabe öffnen.',
    'action.reglages': 'Einstellungen öffnen',
    'action.reglages.tip': 'Die Einstellungen des Arbeitsplatzes öffnen.',
    'action.word': 'Wartende Word-Dateien',
    'action.word.tip': 'Die Liste der abgelegten Word-Dokumente öffnen.',
    'action.documentation': 'Dokumentation öffnen',
    ...
    'action.pagination': 'Paginierung aktualisieren',
    'action.pagination.tip': 'Die Seitenzahlen der Ausgabe neu berechnen und die verschobenen Artikel neu kompilieren.',
    ...
    'detail.pagination-perimee': 'Die Seitenzahlen dieses Artikels folgen nicht mehr der Reihenfolge der Ausgabe. Aktualisieren Sie die Paginierung vor dem Export.',
    'defaut.aucun-article': 'Keine Artikel in dieser Ausgabe',
    'defaut.pas-une-revue': 'Dieser Ordner ist keine Ausgabe',
    'defaut.profil-rien': 'Ausgabe erzeugt absichtlich nichts',
    'defaut.profil-differe': 'Produktionsmodus noch nicht verfügbar',
    'defaut.profil-inconnu': 'Unbekanntes Produktionsprofil',
    'defaut.pdf-verrouille': 'PDF in einer anderen Anwendung geöffnet',
    'detail.pdf-verrouille': 'Schliessen Sie es (Adobe Reader, Vorschau) und speichern Sie erneut.',
    'defaut.balisage-simple': 'PDF mit einfacher Auszeichnung',
    'defaut.balisage-aucun': 'PDF ohne Auszeichnung',
    ...
    'detail.typo-majuscule-accentuee': 'Der Guide du typographe akzentuiert sie, doch der Filter korrigiert nur die Titel – ein englisches Wort kann gleich geschrieben sein. Bei der Korrektur zu entscheiden.',
    'defaut.metafichier-image-native': 'Natives Word-Bild nicht gerendert',
    'defaut.metafichier-placeholder-introuvable': 'Bildersatz auf diesem Rechner fehlt',
    'defaut.champ-vide': 'Feld leer in der Sprache des Artikels',
    'defaut.marque-champ': 'Übersetzungsmarke in einem Feld geblieben',
    'defaut.marque-motcle': 'Übersetzungsmarke bei einem Schlagwort',
    'defaut.sans-langue': 'Sprache des Artikels nicht angegeben',
    'defaut.langue-inconnue': 'Der Zeitschrift unbekannte Sprache',
    'defaut.figure-sans-alt': 'Abbildung ohne Alternativtext',
    'defaut.image-sans-legende': 'Bild ohne Legende',
    'defaut.aucun-pdf': 'Noch kein PDF kompiliert',
    'defaut.pdfua-non-conforme': 'PDF nicht PDF/UA-konform',
    'ressource.champ.distributeur': 'Verleih',
    'detail.pdfua-non-conforme': '{0} Regel(n) werden nicht erfüllt.',
    'defaut.pdfua-regle': 'PDF/UA-Regel nicht erfüllt',
    'defaut.pdfua-outillage': 'PDF/UA-Prüfer ohne Ergebnis',
    'defaut.appel-sans-reference': 'Verweis ohne Eintrag',
    'defaut.appel-ambigu': 'Mehrdeutiger Verweis',
    'defaut.reference-orpheline': 'Nie zitierter Eintrag',
    'defaut.ancrage-inconnu': 'Link auf entfallenen Eintrag',
    'defaut.caractere-sans-repli': 'Zeichen ohne einfache Entsprechung',
    'defaut.bilan': 'Bilanz der Zitatverweise',
    'defaut.import-echec': 'Word nicht konvertiert',
    'defaut.import-restes': 'Word noch in der Warteschlange',
    'defaut.tableau-sans-entete': 'Tabelle ohne Kopfzeile',
    'defaut.langue-deduite': 'Sprache aus dem Dokument abgeleitet',
    ...
    'defaut.pronto-cle-absente': 'Vorlagenfeld leer gelassen',
    'defaut.pronto-type-inconnu': 'Artikeltyp nicht erkannt',
    'defaut.pronto-structure': 'Vorlage nicht eingehalten',
    'defaut.pronto-bloc-ancien': 'Block in alter Form',
    'defaut.pronto-bloc-vide': 'Block ohne Bild und Tabelle',
    'defaut.pronto-cles-sans-contenu': 'Blockschlüssel ohne Inhalt',
    'defaut.pronto-bloc-mal-forme': 'Tabelle in Blockgestalt',
    'defaut.pronto-blocs-colles': 'Verklebte Blöcke, beim Lesen getrennt',
    'defaut.pronto-biblio-tableau': 'Tabelle im Literaturverzeichnis',
    'defaut.pronto-langue-ignoree': 'Sprachfeld ignoriert',
    'defaut.tableau-auteurs-non-lu': 'Tabelle der Autorinnen und Autoren nicht gelesen',
    'defaut.biblio-references-restees': 'Einträge ausserhalb der Liste geblieben',
    'defaut.biblio-non-detachee': 'Literaturverzeichnis nicht ausgelagert',
    'defaut.credit-photo-non-repris': 'Bildnachweis nicht übernommen',
    'defaut.reimport-sans-article': 'Kein Artikel passt zu diesem Word',
    'defaut.reimport-sans-word': 'Kein korrigiertes Word vorhanden',
    'defaut.reimport-fiche-sans-source': 'Ursprungsdokument unbekannt',
    'defaut.reimport-plusieurs-articles': 'Mehrere Artikel für dasselbe Word',
    'defaut.reimport-echec': 'Textersetzung abgebrochen',
    'defaut.reimport-panne': 'Textersetzung gescheitert',
    'defaut.reimport-interrompu': 'Textersetzung unterbrochen',
    'defaut.reimport-reprise-impossible': 'Wiederaufnahme nicht möglich',
    'defaut.reimport-reprise': 'Ersetzung wieder aufgenommen und beendet',
    'defaut.annuler-sans-etat': 'Kein früherer Text aufbewahrt',
    'defaut.fiche-differente': 'Datenblatt und Word weichen ab',
    'detail.fiche-differente': 'Das korrigierte Word sagt nicht dasselbe wie das Datenblatt: Titel, Untertitel oder Autorschaft. Das Datenblatt wurde nicht verändert.',
    'defaut.tableau-conflit': 'Tabellen überarbeitet und neu importiert',
    'detail.tableau-conflit': 'Die hier korrigierten Tabellen wurden durch jene des Word ersetzt. Zu prüfen.',
    'defaut.tableaux-inconnus': 'Zustand der Tabellen unbekannt',
    'defaut.image-perdue': 'Bilder vom Word nicht mitgebracht',
    'detail.image-perdue': 'Sie waren im Artikel und das korrigierte Word bringt sie nicht mit: sie sind an Ort geblieben.',
    'defaut.corps-retravaille': 'Text seit dem Import überarbeitet',
    'detail.corps-retravaille': 'Die hier vorgenommenen Änderungen wurden durch den Text des Word ersetzt.',
    'defaut.biblio-conflit': 'Literaturliste überarbeitet und neu importiert',
    ...
    'defaut.scission-aucun-titre': 'Kein Kapiteltitel gefunden',
    'defaut.scission-chapitre-existe': 'Kapitelordner bereits belegt',
    'defaut.scission-image-introuvable': 'Bild beim Aufteilen nicht gefunden',
    'defaut.scission-tableau-introuvable': 'Tabelle beim Aufteilen nicht gefunden',
    'defaut.scission-liminaire-texte-non-repris': 'Kopftext in keinem Kapitel übernommen',
    'defaut.scission-liminaire-texte-media-introuvable': 'Medium des Kopftexts nicht gefunden',
    'defaut.scission-liminaire-media-introuvable': 'Medium einer Titelei-Datei nicht gefunden',
    'defaut.scission-source-non-supprimee': 'Ursprungsordner nach dem Aufteilen behalten',
    ...
    'defaut.sans-fiche': 'Artikel ohne Metadaten-Datenblatt',
    'defaut.doi-double': 'DOI von zwei Artikeln getragen',
    'defaut.pagination-perimee': 'Paginierung nicht aktuell',
    'defaut.export-refus': 'Export abgelehnt',
    ...
    'ctl.source.typo': 'Typografie',
    'ctl.source.metafichier': 'Native Word-Bilder',
    'ctl.source.scission': 'Aufteilung des Manuskripts',
    'ctl.source.pagination': 'Paginierung',
    ...
    'ctl.action.medias.tip': 'Die Bildverwaltung dieses Artikels öffnen.',
    ...
    'ctl.import.pronto-cle-absente': 'Das Vorlagenfeld «{0}» wurde nicht ausgefüllt. Es geht nichts verloren – es wurde aber auch nichts in die Metadaten übernommen.',
    'ctl.import.pronto-type-inconnu': 'Das Feld «Type d’article» enthält «{0}», was die Vorlage nicht anbietet. Der Typ blieb leer: wählen Sie ihn unter «Metadaten der Artikel».',
    'ctl.import.pronto-structure': 'Dieses Dokument folgt nicht der Form der Vorlage «Pronto»: eine der beiden erwarteten Tabellen am Anfang fehlt. Es wurde nichts automatisch gelesen; ergänzen Sie die Metadaten von Hand oder gehen Sie von der Vorlage aus.',
    'ctl.import.pronto-bloc-ancien': 'Die Tabelle {0} ist ein Abbildungs- oder Tabellenblock in alter Form. Sie wird so gedruckt, wie sie ist, mitsamt ihren Bezeichnungen, und ihre Legende wird weder nummeriert noch als Alternativtext übernommen. Wandeln Sie sie beim nächsten Durchgang um.',
    'ctl.import.pronto-bloc-vide': 'Ein Block kündigt die Legende «{0}» an, trägt aber weder Bild noch Tabelle: die Ablage ist leer geblieben. Ergänzen Sie sie im Word-Dokument und importieren Sie den Artikel neu.',
    'ctl.import.pronto-cles-sans-contenu': 'Es wurden Abbildungs- oder Tabellenschlüssel gefunden (Legende «{0}»), aber weder Bild noch Tabelle folgt darauf: sie bleiben unverändert im Text. Prüfen Sie ihre Position gegenüber dem Bild oder der Tabelle im Dokument.',
    'ctl.import.pronto-bloc-mal-forme': 'Die Tabelle {0} trägt die Bezeichnungen einer Abbildung oder Tabelle, ohne deren Form zu haben. Sie wurde nicht als Block gelesen und wird so gedruckt, wie sie ist. Öffnen Sie das Word-Dokument und gehen Sie vom Block der Vorlage aus.',

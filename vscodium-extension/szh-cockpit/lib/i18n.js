...
const TEXTES_COCKPIT = {
  fr: {
    ...
    'table.aide': 'Cliquez une cellule pour l’éditer (Ctrl+B gras, Ctrl+I italique). Tab/Entrée pour passer d’une cellule à l’autre, Ctrl+Z/Ctrl+Y pour annuler/rétablir, Ctrl+V pour coller un tableau (Excel). Maj+clic ou glisser = plage rectangulaire. En-têtes A/B/C et 1/2/3 : cliquez pour sélectionner, glissez pour réordonner. Clic droit pour insérer, supprimer, fusionner, scinder ou définir un en-tête. Mise en forme du tableau (en-têtes, bordures, zébrage) dans le panneau de droite.',
    ...
    'table.preset.bientot': 'Bientôt disponible',
    'table.modele': 'Modèle {0}',
  ...
  de: {
    ...
    'table.aide': 'Klicken Sie eine Zelle zum Bearbeiten (Ctrl+B fett, Ctrl+I kursiv). Tab/Enter zum Wechseln der Zelle, Ctrl+Z/Ctrl+Y für Rückgängig/Wiederholen, Ctrl+V zum Einfügen einer Tabelle (Excel). Umschalt+Klick oder Ziehen = rechteckiger Bereich. Kopfzeilen A/B/C und 1/2/3: anklicken zum Auswählen, ziehen zum Umordnen. Rechtsklick zum Einfügen, Löschen, Verbinden, Teilen oder Festlegen einer Überschrift. Formatierung der Tabelle (Überschriften, Linien, Zebrastreifen) im Bereich rechts.',
    ...
    'table.preset.bientot': 'Bald verfügbar',
    'table.modele': 'Vorlage {0}',

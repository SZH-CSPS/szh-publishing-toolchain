...
const TEXTES_COCKPIT = {
  fr: {
    ...
    'medias.grille.section': 'Grille d’images',
    ...
    'medias.grille.retirer.tip': 'Rendre à cette image sa place de figure indépendante, juste après la grille.',
    'medias.grille.suiveuse': 'Dans la grille de « {0} » : la légende et le numéro sont ceux de la figure entière.',
    'medias.grille.pastille': 'en grille',
    ...
    'regl.auteurs.maj': 'Liste mise à jour le {0} — {1} nom(s). Elle se rafraîchit seule, au plus une fois par semaine, depuis ojs.szh.ch.',
    'regl.auteurs.jamais': 'Liste pas encore récupérée — elle se construira seule dès qu’ojs.szh.ch sera joignable.',
  ...
  de: {
    ...
    'medias.grille.section': 'Bildraster',
    ...
    'medias.grille.retirer.tip': 'Diesem Bild seinen Platz als eigenständige Abbildung zurückgeben, direkt nach dem Raster.',
    'medias.grille.suiveuse': 'Im Raster von « {0} »: Bildunterschrift und Nummer gehören der ganzen Abbildung.',
    'medias.grille.pastille': 'im Raster',
    ...
    'regl.auteurs.maj': 'Liste aktualisiert am {0} — {1} Name(n). Sie aktualisiert sich selbst, höchstens einmal pro Woche, von ojs.szh.ch.',
    'regl.auteurs.jamais': 'Liste noch nicht abgerufen — sie baut sich selbst auf, sobald ojs.szh.ch erreichbar ist.',

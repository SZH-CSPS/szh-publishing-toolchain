...
$script:SzhTextes = @{
  fr = @{
    ...
    'lanceur.preproc'                       = 'Préprocessing'
    'lanceur.preproc.intro'                 = 'Choisissez le produit, puis un manuscrit à nettoyer.'
    'lanceur.preproc.produit'                = 'Produit :'
    'lanceur.preproc.fichier.titre'         = 'Choisissez un manuscrit'
    'lanceur.preproc.fichier.filtre'        = 'Manuscrits Word et OpenDocument (*.docx;*.odt)|*.docx;*.odt'
    'lanceur.preproc.fichier.aucun'         = 'Aucun manuscrit choisi.'
    'lanceur.preproc.fichier.choisi'        = 'Manuscrit : {0}'
    'lanceur.preproc.dossier'               = 'Ouvrir le dossier'
    'lanceur.preproc.interrompre'           = 'Interrompre'
    'lanceur.preproc.interrompu'            = 'Nettoyage interrompu.'
    'lanceur.preproc.erreur'                = 'Erreur : {0}'
    'lanceur.preproc.resultat.ok'           = '✓ {0}'
    'lanceur.preproc.resultat.echec'        = '⚠ {0}'
    'lanceur.preproc.resultat.termine'      = 'Nettoyage terminé.'
    'lanceur.preproc.resultat.stats'        = 'Statistiques : {0}'
    'lanceur.preproc.resultat.alertes'        = 'Nettoyage terminé : {0} point(s) bloquant(s) à traiter, {1} révision(s) et {2} commentaire(s) posés dans le document, voir le rapport.'
    'lanceur.preproc.echec.inconnu'         = 'Le nettoyeur s’’est arrêté sans explication ; le journal ci-dessus dit où.'
    'lanceur.preproc.wsl.absent'            = 'L’’environnement de fabrication n’’est pas installé sur ce poste. Faites faire l’’installation initiale du poste par le service informatique, puis réessayez. Si cela se répète, écrivez à {0}.'
    'lanceur.preproc.wsl.distro.absente'    = 'L’’environnement qui nettoie les manuscrits ({0}) n’’est pas installé sur ce poste. Faites faire l’’installation initiale du poste par le service informatique, puis réessayez.'
    'lanceur.preproc.cli.absent'            = 'L’’outil de nettoyage des manuscrits est introuvable sur ce poste. Lancez la mise à jour du logiciel, puis réessayez.'
    'lanceur.preproc.chemin.echec'          = 'Le chemin « {0} » n’’a pas pu être transmis à l’’environnement de fabrication.'
  }
  de = @{
    ...
    'lanceur.preproc'                       = 'Vorverarbeitung'
    'lanceur.preproc.intro'                 = 'Wählen Sie das Produkt, dann ein zu bereinigendes Manuskript.'
    'lanceur.preproc.produit'               = 'Produkt:'
    'lanceur.preproc.fichier.titre'         = 'Manuskript wählen'
    'lanceur.preproc.fichier.filtre'        = 'Word- und OpenDocument-Manuskripte (*.docx;*.odt)|*.docx;*.odt'
    'lanceur.preproc.fichier.aucun'         = 'Kein Manuskript ausgewählt.'
    'lanceur.preproc.fichier.choisi'        = 'Manuskript: {0}'
    'lanceur.preproc.dossier'               = 'Ordner öffnen'
    'lanceur.preproc.interrompre'           = 'Unterbrechen'
    'lanceur.preproc.interrompu'            = 'Bereinigung abgebrochen.'
    'lanceur.preproc.erreur'                = 'Fehler: {0}'
    'lanceur.preproc.resultat.ok'           = '✓ {0}'
    'lanceur.preproc.resultat.echec'        = '⚠ {0}'
    'lanceur.preproc.resultat.termine'      = 'Bereinigung abgeschlossen.'
    'lanceur.preproc.resultat.stats'        = 'Statistik: {0}'
    'lanceur.preproc.resultat.alertes'        = 'Bereinigung abgeschlossen: {0} noch zu behebende(r) Punkt(e), {1} Änderung(en) und {2} Kommentar(e) im Dokument, siehe Bericht.'
    'lanceur.preproc.echec.inconnu'         = 'Das Werkzeug ist ohne Erklärung abgebrochen; das Protokoll oben zeigt, wo.'
    'lanceur.preproc.wsl.absent'            = 'Die Produktionsumgebung ist auf diesem Rechner nicht installiert. Lassen Sie die Ersteinrichtung des Arbeitsplatzes durch die Informatik durchführen und versuchen Sie es erneut. Wenn es sich wiederholt, schreiben Sie an {0}.'
    'lanceur.preproc.wsl.distro.absente'    = 'Die Umgebung, die Manuskripte bereinigt ({0}), ist auf diesem Rechner nicht installiert. Lassen Sie die Erstinstallation durch die Informatikabteilung durchführen und versuchen Sie es dann erneut.'
    'lanceur.preproc.cli.absent'            = 'Das Werkzeug zur Manuskriptbereinigung wurde auf diesem Rechner nicht gefunden. Führen Sie die Softwareaktualisierung durch und versuchen Sie es erneut.'
    'lanceur.preproc.chemin.echec'          = 'Der Pfad «{0}» konnte nicht an die Produktionsumgebung übergeben werden.'
  }
  en = @{
    ...
    'lanceur.preproc'                       = 'Preprocessing'
    'lanceur.preproc.intro'                 = 'Choose the product, then a manuscript to clean up.'
    'lanceur.preproc.produit'               = 'Product:'
    'lanceur.preproc.fichier.titre'         = 'Choose a manuscript'
    'lanceur.preproc.fichier.filtre'        = 'Word and OpenDocument manuscripts (*.docx;*.odt)|*.docx;*.odt'
    'lanceur.preproc.fichier.aucun'         = 'No manuscript chosen.'
    'lanceur.preproc.fichier.choisi'        = 'Manuscript: {0}'
    'lanceur.preproc.dossier'               = 'Open the folder'
    'lanceur.preproc.interrompre'           = 'Interrupt'
    'lanceur.preproc.interrompu'            = 'Cleanup interrupted.'
    'lanceur.preproc.erreur'                = 'Error: {0}'
    'lanceur.preproc.resultat.ok'           = '✓ {0}'
    'lanceur.preproc.resultat.echec'        = '⚠ {0}'
    'lanceur.preproc.resultat.termine'      = 'Cleanup finished.'
    'lanceur.preproc.resultat.stats'        = 'Statistics: {0}'
    'lanceur.preproc.resultat.alertes'        = 'Cleanup finished: {0} blocking point(s) to address, {1} tracked change(s) and {2} comment(s) in the document, see the report.'
    'lanceur.preproc.echec.inconnu'         = 'The tool stopped without explanation; the log above shows where.'
    'lanceur.preproc.wsl.absent'            = 'The production environment is not installed on this computer. Ask IT to run the initial workstation setup, then try again. If this keeps happening, write to {0}.'
    'lanceur.preproc.wsl.distro.absente'    = 'The environment that cleans manuscripts ({0}) is not installed on this computer. Have IT support do the initial setup of this computer, then try again.'
    'lanceur.preproc.cli.absent'            = 'The manuscript cleaning tool could not be found on this computer. Run the software update, then try again.'
    'lanceur.preproc.chemin.echec'          = 'The path "{0}" could not be passed to the production environment.'
  }
}
